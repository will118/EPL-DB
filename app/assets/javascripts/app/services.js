...
app.factory('GeneralLiveData', function($http, $q) {
    ...
    methods.table = function() {
        ...
        $http.get('/tablejson/',{cache:true}).success(function(data) {
    ...
    methods.scores = function() {
        ...
        $http.get('/scoresjson/',{cache:true}).success(function(data) {
    ...
    methods.fixtures = function(team) {
        ...
        $http.get('/fixturesjson/' + team,{cache:true}).success(function(data) {
...
app.factory('LiveStatsData', function($http, $q) {
    ...
    methods.scorers = function(team) {
        ...
        $http.get('/topscorers/' + team,{cache:true}).success(function(data) {
    ...
    methods.corner = function(team) {
        ...
        $http.get('/cornerjson/' + team,{cache:true}).success(function(data) {
    ...
    methods.shot = function(team) {
        ...
        $http.get('/shotjson/' + team,{cache:true}).success(function(data) {
    ...
    methods.targets = function(team) {
        ...
        $http.get('/targetjson/' + team,{cache:true}).success(function(data) {
...
app.factory('TeamFormData', function($http, $q) {
    ...
    methods.teamform = function(team) {
        ...
        $http.get('/formjson/' + team,{cache:true}).success(function(data) {
    ...
    methods.oppoform = function(team) {
        ...
        $http.get('/otherformjson/' + team,{cache:true}).success(function(data) {
...
app.factory('BigData', function($http, $q) {
    ...
    methods.squawka = function(team) {
        ...
        $http.get('/megajson/' + team,{cache:true}).success(function(data) {
...
app.factory('MatchDetails', function($http, $q) {
    ...
    methods.prematch = function(team) {
        ...
        $http.get('/prematchjson/' + team,{cache:true}).success(function(data) {
...
app.factory('HomeAwayTeam', function($http, $q) {
    ...
    methods.home = function(team) {
        ...
        $http.get('/hometeam/' + team,{cache:true}).success(function(data) {
    ...
    methods.away = function(team) {
        ...
        $http.get('/awayteam/' + team,{cache:true}).success(function(data) {
